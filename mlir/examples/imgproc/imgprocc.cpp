//===- imgprocc.cpp - The ImgProc Compiler -------------------------------===//
//
// This file implements the entry point for the ImgProc compiler.
//
//===----------------------------------------------------------------------===//
...
/// Returns a ImgProc AST - nullptr on error.
static std::unique_ptr<imgproc::ModuleAST>
