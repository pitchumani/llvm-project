//===- Lexer.h - Lexer for the ImgProc language ------------------------===//
//
// This file implements the Lexer for the ImgProc language.
// This lexer is based on the toy example in LLVM
//
//===-----------------------------------------------------------------------===//

#ifndef IMGPROC_LEXER_H
#define IMGPROC_LEXER_H
...
private:
	...
	/// If the current Token is an string constant, this string contains the value.
